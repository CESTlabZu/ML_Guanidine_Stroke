function vals = matsolv_7pool(pars, x, Delta)
...
p=A1*1./(1+((off-b1)./(0.5.*LW1)).^2)+ A2*1./(1+((off-b2)./(0.5.*LW2)).^2)+A3*1./(1+((off-b3)./(0.5.*LW3)).^2)+A4*1./(1+((off-b4)./(0.5.*LW4)).^2)+A5*1./(1+((off-b5)./(0.5.*LW5)).^2)+A6*1./(1+((off-b6)./(0.5.*LW6)).^2)+A7*1./(1+((off-b7)./(0.5.*LW7)).^2);
